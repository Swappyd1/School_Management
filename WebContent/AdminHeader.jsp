		...
		<div class="navbar navbar-expand-md header-menu-one bg-light">
			<div class="nav-bar-header-one">
				<div class="header-logo">
					<a href="AdminHeader.jsp"> <img src="img/logo.png" alt="logo">
					</a>
				</div>
					...
					<li class="navbar-item dropdown header-admin"><a
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="item-header">
								<h6 class="item-title">Accounting</h6>
							</div>
		...
		<div
			...
			<div class="sidebar-menu-content">
				...
				<li class="nav-item sidebar-nav-item"><a href="#"
						class="nav-link"><i class="flaticon-shopping-list"></i><span>Announcement</span></a>
						<ul class="nav sub-group-menu">
							<li class="nav-item"><a href="AdminViewAnnoucement.jsp"
								class="nav-link"><i class="fas fa-angle-right"></i>View
									Announcement</a></li>
							<li class="nav-item"><a href="AdminSaveAnnouncement.jsp"
					...
					<li class="nav-item sidebar-nav-item"><a href="#"
						...
						<ul class="nav sub-group-menu">
							<li class="nav-item"><a href="AdminViewStudent.jsp"
								class="nav-link"><i class="fas fa-angle-right"></i>View
									Student</a></li>
						</ul></li>
					<li class="nav-item sidebar-nav-item"><a href="#"
						...
						<ul class="nav sub-group-menu">
							<li class="nav-item"><a href="AdminViewTournament.jsp"
								class="nav-link"><i class="fas fa-angle-right"></i>View
									Tournament</a></li>
						</ul></li>
						
						<li class="nav-item sidebar-nav-item"><a href="#"
						class="nav-link"><i class="flaticon-multiple-users-silhouette"></i><span>Staff</span></a>
						<ul class="nav sub-group-menu">
							<li class="nav-item"><a href="AdminViewStaff.jsp"
								class="nav-link"><i class="fas fa-angle-right"></i>View
									Staff</a></li>
						</ul></li>
