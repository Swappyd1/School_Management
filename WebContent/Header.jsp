				...
				<div class="sidebar-menu-content">
					<ul class="nav nav-sidebar-menu sidebar-toggle-view">
						...
						<li class="nav-item sidebar-nav-item"><a href="#"
							...
							<ul class="nav sub-group-menu">
								<li class="nav-item"><a href="ViewParent.jsp" class="nav-link"><i
										class="fas fa-angle-right"></i>View Parents</a></li>
								<li class="nav-item"><a href="SaveParent.jsp"
									class="nav-link menu-active"><i class="fas fa-angle-right"></i>Save
										Parents</a></li>
							</ul></li>
						...
						<li class="nav-item sidebar-nav-item"><a href="#"
							class="nav-link"><i class="flaticon-couple"></i><span>Hostel</span></a>
							<ul class="nav sub-group-menu">
								<li class="nav-item"><a href="ViewHostel.jsp" class="nav-link"><i
										class="fas fa-angle-right"></i>View Hostel</a></li>
								<li class="nav-item"><a href="SaveHostel.jsp"
									class="nav-link menu-active"><i class="fas fa-angle-right"></i>Save
										Hostel</a></li>
							</ul></li>
