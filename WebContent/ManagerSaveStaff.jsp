...
<body>
	...
	<div class="card height-auto">
		<div class="card-body">
			...
			<form action="ManagerSaveStaffServlet" method="post" class="new-added-form">


				<div class="row">
					<div class="col-xl-3 col-lg-6 col-12 form-group">
						<label>Staff name *</label> <input type="text" placeholder=""
							class="form-control" name="name" required>
					</div>
					
					<div class="col-xl-3 col-lg-6 col-12 form-group">
						<label>Position *</label> <input type="text" placeholder=""
					...
					<div class="col-xl-3 col-lg-6 col-12 form-group">
						<label>Join date *</label> <input type="date" placeholder=""
							class="form-control" name="joindate" required>
					</div>
