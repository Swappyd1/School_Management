			...
			<div class="sidebar-menu-content">
				<ul class="nav nav-sidebar-menu sidebar-toggle-view">
					...
					<li class="nav-item sidebar-nav-item"><a href="#"
						class="nav-link"><i class="flaticon-technological"></i><span>Tournament</span></a>
						<ul class="nav sub-group-menu">
							<li class="nav-item"><a href="StudentViewTournament.jsp" class="nav-link"><i
									class="fas fa-angle-right"></i>View Tournament</a></li>
				...
				<li class="nav-item sidebar-nav-item"><a href="#"
						...
						<ul class="nav sub-group-menu">
							<li class="nav-item"><a href="StudentViewSport.jsp" class="nav-link"><i
